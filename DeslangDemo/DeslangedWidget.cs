        ...
        public static System.CodeDom.CodeCompileUnit Widget = Deslanged._CompileUnit(new string[0], new CodeNamespace[] {
                    ...
                    Deslanged._Namespace("CorporateHellscape", new CodeNamespaceImport[0], new CodeTypeDeclaration[] {
                                Deslanged._TypeDeclaration("Widget", true, false, false, false, true, ((MemberAttributes)(0)), TypeAttributes.NotPublic, new CodeTypeParameter[0], new CodeTypeReference[0], new CodeTypeMember[] {
                                            Deslanged._MemberField(new CodeTypeReference(new CodeTypeReference("System.Byte"), 1), "_payload", null, ((MemberAttributes)(0)), new CodeCommentStatement[] {
                                                        new CodeCommentStatement(new CodeComment("our payload - to be filled", false))}, new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                            Deslanged._MemberMethod(new CodeTypeReference("System.String"), "ToString", (MemberAttributes.Override | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                        new CodeMethodReturnStatement(new CodeBinaryOperatorExpression(new CodeBinaryOperatorExpression(new CodePrimitiveExpression("[Widget - "), CodeBinaryOperatorType.Add, new CodeMethodInvokeExpression(new CodeMethodReferenceExpression(new CodeTypeReferenceExpression(new CodeTypeReference("System.Convert")), "ToBase64String"), new CodeExpression[] {
                                            ...
                                            new CodeCommentStatement(new CodeComment("Base widget implementation", true)),
