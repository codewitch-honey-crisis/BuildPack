...
"/*" 	{ if(!_TryReadUntilBlockEnd("*/")) return -1;UpdatePosition(yytext); return Skip(426);UpdatePosition(yytext); return Skip(426); }
\/\/[^\n]* 	{ UpdatePosition(yytext); return Skip(425); }
...
#[A-Za-z]+ 	{ if(!_TryReadUntilBlockEnd("\n")) return -1;UpdatePosition(yytext); return Skip(441);UpdatePosition(yytext); return Skip(441); }
