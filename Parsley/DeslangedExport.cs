                        ...
                        Deslanged._Namespace("Parsley", new CodeNamespaceImport[0], new CodeTypeDeclaration[] {
                                    Deslanged._TypeDeclaration("ParserContext", true, false, false, false, true, ((MemberAttributes)(0)), TypeAttributes.NotPublic, new CodeTypeParameter[0], new CodeTypeReference[] {
                                                ...
                                                Deslanged._MemberMethod(new CodeTypeReference("ParserContext"), "GetLookAhead", (MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                            ...
                                                            new CodeMethodReturnStatement(new CodeObjectCreateExpression(new CodeTypeReference("ParserContext"), new CodeExpression[] {
            ...
            return Deslanged._CompileUnit(new string[0], new CodeNamespace[] {
                        ...
                        Deslanged._Namespace("Parsley", new CodeNamespaceImport[0], new CodeTypeDeclaration[] {
                                    Deslanged._TypeDeclaration("LookAheadEnumerator", true, false, false, false, false, ((MemberAttributes)(0)), TypeAttributes.NotPublic, new CodeTypeParameter[] {
                                                ...
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_Enumerating", new CodePrimitiveExpression(0), MemberAttributes.Const, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_NotStarted", new CodePrimitiveExpression(-2), MemberAttributes.Const, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_Ended", new CodePrimitiveExpression(-1), MemberAttributes.Const, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_Disposed", new CodePrimitiveExpression(-3), MemberAttributes.Const, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference("IEnumerator`1", new CodeTypeReference[] {
                                                                new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)}), "_inner", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_state", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_DefaultCapacity", new CodePrimitiveExpression(16), MemberAttributes.Const, new CodeCommentStatement[] {
                                                ...
                                                Deslanged._MemberField(new CodeTypeReference(typeof(float)), "_GrowthFactor", new CodePrimitiveExpression(0.9F), MemberAttributes.Const, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(new CodeTypeReference("T"), 1), "_queue", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_queueHead", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_queueCount", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._Constructor((MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[] {
                                                            new CodeParameterDeclarationExpression(new CodeTypeReference("IEnumerator`1", new CodeTypeReference[] {
                                                ...
                                                Deslanged._MemberMethod(new CodeTypeReference(typeof(void)), "Reset", (MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                            ...
                                                            new CodeAssignStatement(new CodeFieldReferenceExpression(new CodeThisReferenceExpression(), "_state"), new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(new CodeTypeReference("Parsley.LookAheadEnumerator`1", new CodeTypeReference[] {
                                                                                    new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)})), "_NotStarted"))}, new CodeTypeReference[0], null, new CodeCommentStatement[] {
                                                            new CodeCommentStatement("<summary>", true),
                                                ...
                                                Deslanged._MemberMethod(new CodeTypeReference(typeof(void)), "Dispose", (MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                            new CodeConditionStatement(new CodeBinaryOperatorExpression(new CodePrimitiveExpression(false), CodeBinaryOperatorType.ValueEquality, new CodeBinaryOperatorExpression(new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(new CodeTypeReference("Parsley.LookAheadEnumerator`1", new CodeTypeReference[] {
                                                                        ...
                                                                        new CodeAssignStatement(new CodeFieldReferenceExpression(new CodeThisReferenceExpression(), "_state"), new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(new CodeTypeReference("Parsley.LookAheadEnumerator`1", new CodeTypeReference[] {
                                                                                                new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)})), "_Disposed"))}, new CodeStatement[0])}, new CodeTypeReference[0], null, new CodeCommentStatement[] {
                                                            new CodeCommentStatement("<summary>", true),
                                    ...
                                    Deslanged._TypeDeclaration("LookAheadEnumeratorEnumerable", true, false, false, false, false, ((MemberAttributes)(0)), TypeAttributes.NotPublic, new CodeTypeParameter[] {
                                                ...
                                                new CodeTypeReference("IEnumerable`1", new CodeTypeReference[] {
                                                            new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)})}, new CodeTypeMember[] {
                                                Deslanged._MemberField(new CodeTypeReference("LookAheadEnumerator`1", new CodeTypeReference[] {
                                                                new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)}), "_outer", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._Constructor((MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[] {
                                                ...
                                                Deslanged._MemberMethod(new CodeTypeReference("IEnumerator`1", new CodeTypeReference[] {
                                                            ...
                                                            new CodeMethodReturnStatement(new CodeDelegateCreateExpression(new CodeTypeReference("LookAheadEnumeratorEnumerator`1", new CodeTypeReference[] {
                                                                                new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)}), new CodeThisReferenceExpression(), "_outer"))}, new CodeTypeReference[] {
                                                            new CodeTypeReference("IEnumerable`1", new CodeTypeReference[] {
                                    ...
                                    Deslanged._TypeDeclaration("LookAheadEnumeratorEnumerator", true, false, false, false, false, ((MemberAttributes)(0)), TypeAttributes.NotPublic, new CodeTypeParameter[] {
                                                ...
                                                Deslanged._MemberField(new CodeTypeReference("LookAheadEnumerator`1", new CodeTypeReference[] {
                                                                new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)}), "_outer", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference(typeof(int)), "_index", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberField(new CodeTypeReference("T"), "_current", null, ((MemberAttributes)(0)), new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._Constructor((MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[] {
                                                            new CodeParameterDeclarationExpression(new CodeTypeReference("LookAheadEnumerator`1", new CodeTypeReference[] {
                                                                            new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)}), "outer")}, new CodeExpression[0], new CodeExpression[0], new CodeStatement[] {
                                                ...
                                                Deslanged._MemberMethod(new CodeTypeReference(typeof(void)), "Dispose", (MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                            new CodeAssignStatement(new CodeFieldReferenceExpression(new CodeThisReferenceExpression(), "_index"), new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(new CodeTypeReference("Parsley.LookAheadEnumeratorEnumerator`1", new CodeTypeReference[] {
                                                                                    new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)})), "_Disposed"))}, new CodeTypeReference[0], null, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null),
                                                Deslanged._MemberMethod(new CodeTypeReference(typeof(bool)), "MoveNext", (MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                            new CodeVariableDeclarationStatement(new CodeTypeReference("T"), "value", null),
                                                            new CodeConditionStatement(new CodeBinaryOperatorExpression(new CodePrimitiveExpression(0), CodeBinaryOperatorType.GreaterThan, new CodeFieldReferenceExpression(new CodeThisReferenceExpression(), "_index")), new CodeStatement[] {
                                                                        new CodeConditionStatement(new CodeBinaryOperatorExpression(new CodeFieldReferenceExpression(new CodeThisReferenceExpression(), "_index"), CodeBinaryOperatorType.ValueEquality, new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(new CodeTypeReference("Parsley.LookAheadEnumeratorEnumerator`1", new CodeTypeReference[] {
                                                ...
                                                Deslanged._MemberMethod(new CodeTypeReference(typeof(void)), "Reset", (MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                            new CodeAssignStatement(new CodeFieldReferenceExpression(new CodeThisReferenceExpression(), "_index"), new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(new CodeTypeReference("Parsley.LookAheadEnumeratorEnumerator`1", new CodeTypeReference[] {
                                                                                    new CodeTypeReference("T", CodeTypeReferenceOptions.GenericTypeParameter)})), "_NotStarted"))}, new CodeTypeReference[0], null, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null)}, new CodeCommentStatement[0], new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0], null)}, new CodeCommentStatement[0])}, new CodeAttributeDeclaration[0], new CodeDirective[0], new CodeDirective[0]);
        }
    }
}
