                        ...
                        Deslanged._Namespace("Parsley", new CodeNamespaceImport[0], new CodeTypeDeclaration[] {
                                    Deslanged._TypeDeclaration("ParserContext", true, false, false, false, true, ((MemberAttributes)(0)), TypeAttributes.NotPublic, new CodeTypeParameter[0], new CodeTypeReference[] {
                                                ...
                                                Deslanged._MemberMethod(new CodeTypeReference("ParserContext"), "GetLookAhead", (MemberAttributes.Final | MemberAttributes. Public), new CodeParameterDeclarationExpression[0], new CodeStatement[] {
                                                            ...
                                                            new CodeExpressionStatement(new CodeMethodInvokeExpression(new CodeMethodReferenceExpression(new CodeVariableReferenceExpression("result"), "SetLocation"), new CodeExpression[] {
                                                                            new CodeBinaryOperatorExpression(new CodePropertyReferenceExpression(new CodeThisReferenceExpression(), "Line"), CodeBinaryOperatorType.Subtract, new CodePrimitiveExpression(1)),
                                                                            new CodeBinaryOperatorExpression(new CodePropertyReferenceExpression(new CodeThisReferenceExpression(), "Column"), CodeBinaryOperatorType.Subtract, new CodePrimitiveExpression(1)),
