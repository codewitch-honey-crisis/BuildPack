...
using System.IO;
	...
	internal partial class ExpressionParser : IEnumerable<Token>
	{
...
public const int whitespace = 20;
		...
		public ExpressionParser(Stream input, string fallbackCodePage = null)
		{
			if (null == input)
		...
		public IEnumerator<Token> GetEnumerator()
		{
			...
			var result = new ExpressionParserEnumerator(_input, _fallbackCodePage);
			_called = true;
			return result;
		}
	...
	internal partial class ExpressionParserEnumerator : IEnumerator<Token>
	{
		...
		Scanner _outer;
		public ExpressionParserEnumerator(Stream input, string fallbackCodePage)
		{
