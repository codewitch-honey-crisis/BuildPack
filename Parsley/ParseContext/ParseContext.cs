// a class that helps with writing hand-rolled parsers
using System;
...
namespace Parsley
{
	...
	public partial class ParseContext : IDisposable , IEnumerable<char>
	{
		...
		private class _Enumerator : IEnumerator<char>
		{
			ParseContext _outer;
			public _Enumerator(ParseContext outer)
			{
				_outer = outer;
			}
			public char Current {
				get {
					var i = _outer.Current;
					if (0 > i)
					{
						switch (i)
						{
