...
// Edits to this file will require a pre-build step, and the inclusion of rolex.exe and Regex.dll
// in the *source/project/slang directory* (not the bin folder - in order to enable)
