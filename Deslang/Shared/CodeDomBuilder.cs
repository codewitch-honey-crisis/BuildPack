...
{
	/// <summary>
	/// We use this class to help deserialize our arrays. All it does is make it so 
	/// we can instantiate complex code objects entirely inline. Deslang rips methods
	/// out of this as needed to import them into the code it generates.
	/// </summary>
