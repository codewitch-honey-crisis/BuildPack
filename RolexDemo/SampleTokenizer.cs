...
namespace RolexDemo {
    ...
    internal class TableTokenizerEnumerator : IEnumerator<Token> {
        ...
        public TableTokenizerEnumerator(DfaEntry[] dfaTable, string[] blockEnds, int[] nodeFlags, IEnumerator<char> input) {
            ...
            this._nodeFlags = nodeFlags;
            this._input = input;
            this._state = RolexDemo.TableTokenizerEnumerator._BeforeBegin;
        ...
        public Token Current {
            get {
                ...
                if ((RolexDemo.TableTokenizerEnumerator._Enumerating > this._state)) {
                    // check which state we're in, and throw accordingly
                    if ((RolexDemo.TableTokenizerEnumerator._BeforeBegin == this._state)) {
                        throw new InvalidOperationException("The cursor is before the start of the enumeration");
                    }
                    if ((RolexDemo.TableTokenizerEnumerator._AfterEnd == this._state)) {
                        throw new InvalidOperationException("The cursor is after the end of the enumeration");
                    }
                    if ((RolexDemo.TableTokenizerEnumerator._Disposed == this._state)) {
                        RolexDemo.TableTokenizerEnumerator._ThrowDisposed();
                    }
                }
        ...
        void System.Collections.IEnumerator.Reset() {
            ...
            if ((false 
                        == (RolexDemo.TableTokenizerEnumerator._BeforeBegin == this._state))) {
                this._input.Reset();
            }
            this._state = RolexDemo.TableTokenizerEnumerator._BeforeBegin;
            this._line = 1;
        ...
        bool System.Collections.IEnumerator.MoveNext() {
            ...
            ; (false == done); 
                ...
                if ((RolexDemo.TableTokenizerEnumerator.ErrorSymbol < this._current.SymbolId)) {
                    ...
                    if (((false 
                        ...
                        if ((false == this._TryReadUntilBlockEnd(be))) {
                            this._current.SymbolId = RolexDemo.TableTokenizerEnumerator.ErrorSymbol;
                        }
                    }
                    if (((RolexDemo.TableTokenizerEnumerator.ErrorSymbol < this._current.SymbolId) 
                                && (false 
            ...
            if ((RolexDemo.TableTokenizerEnumerator._EosSymbol == this._current.SymbolId)) {
                this._state = RolexDemo.TableTokenizerEnumerator._AfterEnd;
            }
            return (false 
                        == (RolexDemo.TableTokenizerEnumerator._AfterEnd == this._state));
        }
        void IDisposable.Dispose() {
            this._input.Dispose();
            this._state = RolexDemo.TableTokenizerEnumerator._Disposed;
        }
                ...
                if ((false 
                    ...
                    if (('\n' == this._input.Current)) {
                        ...
                        if (('\t' == this._input.Current)) {
                            this._column = (this._column + RolexDemo.TableTokenizerEnumerator._TabWidth);
                        }
                        else {
                    ...
                    if (('\n' == this._input.Current)) {
                        ...
                        if (('\t' == this._input.Current)) {
                            this._column = (this._column 
                                        + (RolexDemo.TableTokenizerEnumerator._TabWidth - 1));
                        }
                    }
                }
                return true;
            }
            this._state = RolexDemo.TableTokenizerEnumerator._InnerFinished;
            return false;
        }
        ...
        bool _TryReadUntilBlockEnd(string blockEnd) {
            for (
            ; ((false 
                        == (RolexDemo.TableTokenizerEnumerator._InnerFinished == this._state)) 
            ...
            if ((RolexDemo.TableTokenizerEnumerator._BeforeBegin == this._state)) {
                if ((false == this._MoveNextInput())) {
                    ...
                    if ((false 
                        ...
                        return RolexDemo.TableTokenizerEnumerator.ErrorSymbol;
                    }
                }
                this._state = RolexDemo.TableTokenizerEnumerator._Enumerating;
            }
            else {
                if (((RolexDemo.TableTokenizerEnumerator._InnerFinished == this._state) 
                            || (RolexDemo.TableTokenizerEnumerator._AfterEnd == this._state))) {
                    // if we're at the end just return the end symbol
                    return RolexDemo.TableTokenizerEnumerator._EosSymbol;
                }
            }
            bool done = false;
            for (
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Rolex", "0.2.0.0")]
    internal partial class SampleTokenizer : TableTokenizer {
